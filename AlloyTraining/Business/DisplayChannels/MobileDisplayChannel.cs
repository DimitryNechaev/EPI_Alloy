...
namespace AlloyTraining.Business.DisplayChannels
{
    public class MobileDisplayChannel : DisplayChannel
    {
        ...
        public override string ResolutionId => new iPhone6().Id;
    }

    public class iPhone6 : IDisplayResolution
    {
        public string Id => "iphone6";
        public string Name => "iPhone 6 (375 x 667)";
